...
| Solution | Notes |
|---|---|
| Air-cooled / closed-loop cooling systems | Removes evaporative water loss entirely; higher energy cost trade-off |
| Reclaimed/greywater cooling | Already used by some hyperscalers; needs local wastewater infrastructure (see Maynilad's New Clark City proposal) |
| Site selection tied to real watershed capacity, not just power/land availability | The core failure mode in New Clark City — land and power were secured before water was |
| Waste heat reuse (district heating, etc.) | Doesn't solve water use directly but reduces the cooling load driving it |
